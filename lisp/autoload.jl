...
(autoload 'rm-restrict-to-sender "rm-restrict" t)
(autoload 'rm-restrict-to-recipient "rm-restrict" t)
(autoload 'rm-restrict-to-address "rm-restrict" t)
(autoload 'rm-restrict-to-subject "rm-restrict" t)
(autoload 'rm-restrict-to-message-id "rm-restrict" t)
...
(autoload 'mime-encode-keymap "mime-encode")
...
(autoload 'html-display-map "html-display")
